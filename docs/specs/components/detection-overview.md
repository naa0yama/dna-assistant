...
ゲームアップデート後、 WGC がレポートするフレームサイズがクライアント領域(タイトルバーなし)に変化した。

| キャプチャ          | ゲーム領域  | Round ROI | ステータス              |
| ------------------- | ----------- | --------- | ----------------------- |
| FHD `1920x1080`     | `1920x1080` | `455x108` | OK (ポストアップデート) |
| 1600x900 `1600x900` | `1600x900`  | `379x90`  | OK (ポストアップデート) |
| FHD `1922x1112`     | `1922x1081` | `455x108` | OK (プリアップデート)   |
| 720p `1282x752`     | `1282x721`  | `303x72`  | OK (プリアップデート)   |
