...
ゲームアップデート後は WGC フレームサイズ = ゲーム領域(タイトルバーなし)。

| キャプチャ | 実サイズ    | タイトルバー | ゲーム領域  | ROI サイズ | ステータス              |
| ---------- | ----------- | ------------ | ----------- | ---------- | ----------------------- |
| FHD        | `1920x1080` | なし         | `1920x1080` | `449x29`   | OK (ポストアップデート) |
| 1600x900   | `1600x900`  | なし         | `1600x900`  | `374x24`   | OK (ポストアップデート) |
| FHD        | `1922x1112` | `31px`       | `1922x1081` | `449x29`   | OK (プリアップデート)   |
| 720p       | `1282x752`  | `31px`       | `1282x721`  | `299x19`   | OK (プリアップデート)   |
...
| カテゴリ              | テスト数 | 内容                                                                   |
| --------------------- | -------- | ---------------------------------------------------------------------- |
| 1600x900 フルフレーム | 1 件     | ポストアップデート: タイトルバーなし → `crop_titlebar()` → `analyze()` |

フィクスチャは実際のゲームプレイから取得。
